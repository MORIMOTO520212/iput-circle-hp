      ...
      ?>
        ...
        <form class="register mx-3 mx-sm-auto mt-5 needs-validation" action="" method="post" novalidate>
          ...
          <div class="input-group flex-nowrap mb-3">
            ...
            <input type="text" id="username" minlength="1" maxlength="15" pattern="^[a-zA-Z0-9_]{1,15}$" class="form-control mb-0" name="username" placeholder="ユーザー名を半角英数で入力してください" aria-label="ユーザー名を入力してください" required>
          </div>
          <!-- 氏名 -->
          <div class="row row-cols-1 row-cols-sm-2 mb-3">
            <div class="col mb-2 mb-sm-auto">
              <div class="input-group flex-nowrap">
                ...
                <input type="text" minlength="1" maxlength="20" pattern="^[a-zA-Zぁ-んーァ-ヶーｱ-ﾝﾞﾟ一-龠]{1,12}$" class="form-control" name="lastname" id="lastname" placeholder="氏" aria-label="氏" required>
              </div>
            </div>
            <div class="col">
              <div class="input-group flex-nowrap">
                <span class="input-group-text">名</span>
                <input type="text" minlength="1" maxlength="20" pattern="^[a-zA-Zぁ-んーァ-ヶーｱ-ﾝﾞﾟ一-龠]{1,12}$" class="form-control" name="firstname" id="firstname" placeholder="名" aria-label="名" required>
              </div>
            </div>
          </div>
          <!-- 学校のメールアドレス -->
          <div class="input-group flex-nowrap mb-3">
            ...
            <input type="text" id="email" minlength="2" maxlength="50" class="form-control mb-0" name="email" placeholder="学校のメールアドレスを入力してください" aria-label="学校のメールアドレスを入力してください" required>
          </div>
          <!-- パスワード -->
          <div class="input-group flex-nowrap mb-3">
            <span class="input-group-text">
            ...
            <input type="password" minlength="6" maxlength="16" class="form-control mb-0" name="password" placeholder="パスワードを入力してください" aria-label="パスワードを入力してください" required>
          </div>
      ...
      <a class="list-group-item mt-1" href="<?php echo $article->link; ?>">
        ...
        <div class="d-flex w-100 justify-content-between mb-1">
          <div class='overflow-hidden'>
            <h5 class="m-0 line-clamp-1"><?php echo $article->title; //タイトル 
                                          ?></h5>
          </div>
