      ...
      <div class="mt-5">
        ...
        <div class="mainarea">
          ...
          <div class="mb-3">
            ...
            <input type="text" maxlength="19" class="form-control" id="circle-name-input" name="circleName" placeholder="サークル名を入力してください" value="<?php echo $input['circleName'] ?? ''; ?>" aria-label="サークル名を入力してください" aria-describedby="circle-name-help" required>
          ...
          <div class="mb-3">
            ...
            <input type="number" min="1" max="999" class="form-control" id="input-belong" name="belongNum" placeholder="10" value="<?php echo $input['belongNum'] ?? ''; ?>" required>
          </div>

          <!-- 活動日程 -->
          <div class="mb-3">
            <label class="form-label" for="schedule">活動日程</label>
            <input type="text" maxlength="15" class="form-control" id="schedule" name="schedule" placeholder="例）月曜日、土曜日" value="<?php echo $input['schedule'] ?? ''; ?>" required>
            <div class="invalid-feedback">
          ...
          <div class="mb-3">
            ...
            <input type="text" maxlength="13" class="form-control" id="place" name="place" placeholder="例）コクーンタワー、Discord、LINE" value="<?php echo $input['place'] ?? ''; ?>" required>
            <div class="invalid-feedback">
          ...
          <div class="mb-3">
            ...
            <input type="date" class="form-control" id="input-establishmentDate" name="establishmentDate" aria-label="input-establishmentDate" value="<?php echo $input['establishmentDate'] ?? '2022-12-12'; ?>" required>
          </div>

          <div class="mb-3">
            <label class="form-label" for="input">活動頻度</label>
            <input type="text" maxlength="10" class="form-control" id="activity-frequency" name="activityFrequency" placeholder="例）毎週、不定期" aria-label="activity-frequency" value="<?php echo $input['activityFrequency'] ?? ''; ?>" required>
            <div class="invalid-feedback">
          ...
          <div class="mb-3">
            ...
            <input type="text" maxlength="30" class="form-control" id="membership-free" name="membershipFree" placeholder="例）2000円/年、なし" aria-label="membership-free" value="<?php echo $input['membershipFree'] ?? ''; ?>" required>
            <div class="invalid-feedback">
              30文字以内で入力してください。
            </div>
          </div>
            ...
            <div class="d-flex justify-content-around flex-wrap">
              ...
              ?>
                <div class="form-check">
                  <input class="form-check-input" type="checkbox" id="<?php echo "chkbox-$i"; ?>" name="features[]" value="<?php echo $features[$i]; ?>" <?php echo (($features[$i] != '大学公認' &&  in_array($features[$i], ($input['features'] ?? array()))) || ($features[$i] == '大学公認' && $input['official'] == 'official')) ? 'checked' : ''; ?> <?php echo $features[$i] == '大学公認' ? 'disabled' : ''; ?>>
          ...
          <div class="mb-3">
            ...
            <input type="text" maxlength="30" pattern="^[a-zA-Z0-9_]{1,40}$" class="form-control" id="twitter-username" name="twitterUserName" placeholder="ユーザー名" aria-label="twitter-username" value="<?php echo $input['twitterUserName'] ?? '' ?>">
            <div class="form-text">
      ...
      <div class="mt-5">
        ...
        <div class="mainarea">
          <div class="mb-3">
            ...
            <input type="text" maxlength="50" class="form-control" id="contact-mailaddress" name="contactMailAddress" value="<?php echo $input['contactMailAddress'] ?? wp_get_current_user()->user_email; ?>" placeholder="taro.yamada@gmail.com" aria-describedby="help" required>
          ...
          <div class="mb-3">
            ...
            <input type="text" maxlength="30" class="form-control" id="representative" name="representative" placeholder="山田太郎" aria-describedby="help" value="<?php echo $input['representative'] ?? ''; ?>" required>
            <div id="help" class="form-text">
